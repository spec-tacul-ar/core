<template>
    <Tooltip :enabled="!has_slot" :text="tooltip">
        <RouterLink
            :to="destination"
            class="flex items-center whitespace-nowrap p-2 rounded-full border border-gray-100 transition-colors hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800"

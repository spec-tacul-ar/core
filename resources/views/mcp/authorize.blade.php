        ...
        <div class="w-full max-w-lg">
            <div class="mb-6 flex justify-center">
                <a href="/" aria-label="{{ config('app.name', 'Spectacular') }}">
                    <img src="/images/logo.svg" alt="{{ config('app.name', 'Spectacular') }}" class="h-10 w-auto">
                </a>
            </div>

            <section class="rounded-lg bg-white shadow-lg p-4 sm:p-8">
                <svg xmlns="http://www.w3.org/2000/svg" class="fill-current text-gray-600 size-16 mx-auto mb-6" viewBox="0 0 16 16">

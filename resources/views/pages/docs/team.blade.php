<x-layout.docs title="Roles">
    <article class="prose">
        ...
        <h3>Editors</h3>
        <p>Editors can view and edit the specification. Developers are a good fit for this role as it lets them update progress, block requirements and create unknowns.</p>
